...
// Original source code: https://github.com/minio/minio/blob/master/cmd/sts-errors.go
...
func writeSTSErrorResponse(ctx context.Context, w http.ResponseWriter, errCode STSErrorCode, err error) {
	...
	encodedErrorResponse := service.EncodeResponse(ctx, stsErrorResponse)
	service.WriteResponse(ctx, w, stsErr.HTTPStatusCode, encodedErrorResponse, service.MimeXML)
}
